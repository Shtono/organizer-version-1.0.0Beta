...
function addToLocalStorageChecked(taskObject) {
    let tasks;
    if (localStorage.getItem('tasksChecked') !== null) {
        tasks = JSON.parse(localStorage.getItem('tasksChecked'))
    } else {
        tasks = [];
    }
    tasks.push(taskObject);
    localStorage.setItem('tasksChecked', JSON.stringify(tasks));
}
...
function removeFromLocalStorageChecked(taskObject) {
    let tasks = JSON.parse(localStorage.getItem('tasksChecked'));
